...
from mongoengine import register_connection, get_db
...
def patched_create_coll(self, name: str, **kwargs) -> object:
    ...
    EXAMPLES::
        ...
        sage: from hilbert_maass.database.tests import patched_create_coll
...
def connect_mockdb() -> None:
    ...
    EXAMPLES::
        ...
        sage: from hilbert_maass.database.tests import connect_mockdb
...
def insert_fixtures(reset_db: bool = False):
    ...
    EXAMPLES::
        ...
        sage: from hilbert_maass.database.tests import connect_mockdb, insert_fixtures
        sage: connect_mockdb()
        sage: insert_fixtures(reset_db=True)
        sage: from hilbert_maass.all import HilbertMaassFormDB
        sage: len(HilbertMaassFormDB.objects) > 0
        True
    """
    from hilbert_maass.all import HilbertMaassFormDB, HilbertMaassFormSpace, HilbertMaassForm
...
def return_db_parameters():
    ...
    EXAMPLES::
        ...
        sage: from hilbert_maass.database.tests import return_db_parameters
    ...
    """
    return {
        "coefficients": {"M": [[-1, 1], [-1, 1]],
                         "coefficients": [["-1.00000000000000 - 1.00000000000000*I"],
                                      ["-1.00000000000000"],
                         ...
                         "spectral_parameter": [
                             ...
                             {"prec": 53, "val": "0.500000000000000 + 1.00000000000000*I"}],
                         "set_coefficients": {},
                         "space": {"number_field": {"polynomial": "x^2 - 5", "names": ["a"]},
                                   "cuspidal": False},
                         "index_tuples": None,
                         "Y": [0.3, 0.3],
                         "Q": [2, 2]},
        "parent": {"number_field": {"polynomial": "x^2 - 5", "names": ["a"]},
                   "cuspidal": False}
    }

...
import logging
from typing import ParamSpec, ClassVar, Any
...
class HilbertMaassformQuerySet(QuerySetCompat):
    ...
    def __getitem__(self, item):
        ...
        EXAMPLES::
            ...
            sage: from hilbert_maass.database.models import HilbertMaassFormDB
    ...
    def with_q_precision(self, q: tuple[Integer_t] = None) -> QuerySet:
        ...
        if not q:
            return self
        conditions = [
            {f"coefficients.Q.{i}": {"$gte": int(q[i])}} for i in range(len(q))
        ]
...
class HilbertMaassFormDB(DBObjectBase):
    ...
    def save(self, **kwargs: P.kwargs):
        ...
        EXAMPLES::
            ...
            sage: from hilbert_maass.database.models import HilbertMaassFormDB
            sage: from hilbert_maass.database.tests import connect_mockdb, return_db_parameters
            sage: from hilbert_maass.all import HilbertMaassFormSpace
            sage: connect_mockdb()

...
from maass_forms_klein.hyperbolic_space.geometry_utils import reduce_cover, circle_is_contained
if TYPE_CHECKING:
...
from .types import Rectangle, Parallelogram, Circle

from maass_forms_klein.hyperbolic_space.word_utils import is_equivalent_mod_parabolic, \
    word_list_sort_key, reduce_word, word_to_circle

from maass_forms_klein.hyperbolic_space.parallelogram import parallelogram_intersect_circle, \

...
from knot_maass.modform.utils import Real_t, Integer_t, Complex_t
...
class UpperHalfSpace(FreeModule_generic):
    ...
    def _element_constructor_(self, e: Any, *args: P.args, **kwargs: P.kwargs):
        ...
        EXAMPLES:
            ...
            sage: from knot_maass.hyperbolic_space.upper_half_space import UpperHalfSpace
    ...
    def _coerce_map_from_(self, S):
        ...
        EXAMPLES::
            ...
            sage: from knot_maass.hyperbolic_space.upper_half_space import UpperHalfSpace
            sage: from knot_maass.hyperbolic_space.upper_half_space import UpperHalfSpaceElement

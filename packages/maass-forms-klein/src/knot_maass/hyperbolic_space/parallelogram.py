...
"""
from knot_maass.hyperbolic_space.word_utils import translation_tuple_to_word
...
from knot_maass.hyperbolic_space.types import Parallelogram, Circle, Line, Rectangle
...
def reduce_in_parallelogram(p: Parallelogram, points: list[Vector],
    ...
    EXAMPLES:
        ...
        sage: from knot_maass.hyperbolic_space.parallelogram import reduce_in_parallelogram
        sage: from knot_maass.hyperbolic_space.types import Parallelogram
        sage: from knot_maass.hyperbolic_space.types import Point
...
def reduce_list_to_parallelogram(p: Parallelogram, word_circle_list: list[tuple[str, Circle]]):
    ...
    EXAMPLES:
        ...
        sage: from knot_maass.hyperbolic_space.parallelogram import reduce_list_to_parallelogram
        sage: from knot_maass.hyperbolic_space.types import Parallelogram
...
def point_on_boundary_of_parallelogram(point: Vector, p: Parallelogram, verbose: bool = False)\
    ...
    EXAMPLES::
        ...
        sage: from knot_maass.hyperbolic_space.utils import point_on_boundary_of_parallelogram
        sage: from knot_maass.hyperbolic_space.types import Parallelogram
        sage: v1 = (3.46410161513775, 0.000000000000000)
        sage: v2 = (0.000000000000000, 1.00000000000000)
...
def parallelogram_intersect_circle(p: Parallelogram, cr: Circle,
    ...
    EXAMPLES::
        ...
        sage: from knot_maass.hyperbolic_space.types import Circle
        sage: from knot_maass.hyperbolic_space.types import Parallelogram
        sage: from knot_maass.hyperbolic_space.utils import parallelogram_intersect_circle
    ...
    from knot_maass.hyperbolic_space.geometry_utils import point_in_circle
...
def point_in_parallelogram(c: Vector, p: Parallelogram) -> bool:
    ...
    EXAMPLES::
        ...
        sage: from knot_maass.hyperbolic_space.types import Circle
        sage: from knot_maass.hyperbolic_space.types import Parallelogram
        sage: from knot_maass.hyperbolic_space.parallelogram import point_in_parallelogram
        sage: cr = Circle(center=vector((0,0)), radius=1)
...
def circle_outside_parallelogram(c: Circle, p: Parallelogram, scaling_factor: Real_t = 1) -> bool:
    ...
    EXAMPLES::
        ...
        sage: from knot_maass.hyperbolic_space.types import Circle
        sage: from knot_maass.hyperbolic_space.types import Parallelogram
        sage: from knot_maass.hyperbolic_space.parallelogram import circle_outside_parallelogram
        sage: cr = Circle(center=vector((0,0)), radius=1)
        sage: p = Parallelogram(base=vector((-0.5,-0.5)), v1=vector((1,0)), v2=vector((0,1)))
    ...
    from knot_maass.hyperbolic_space.geometry_utils import circle_intersects_circle
...
def perpendicular(v: Vector) -> Vector:
    ...
    EXAMPLES::
        ...
        sage: from knot_maass.hyperbolic_space.types import Vector
        sage: from knot_maass.hyperbolic_space.parallelogram import perpendicular
        sage: v = vector((1, 0))
...
def parallelogram_to_lines(p: Parallelogram) -> tuple[Line, Line, Line, Line]:
    ...
    EXAMPLES:
        sage: from knot_maass.hyperbolic_space.types import Parallelogram
        sage: from knot_maass.hyperbolic_space.parallelogram import parallelogram_to_lines
...
def points_between(A: Vector, B: Vector, C: Vector) -> bool:
    ...
    EXAMPLES:
        ...
        sage: from knot_maass.hyperbolic_space.types import vector
        sage: from knot_maass.hyperbolic_space.parallelogram import points_between
...
def parallelogram_in_circle(cr: Circle, p: Parallelogram, scaling_factor: Real_t = 1) -> bool:
    ...
    EXAMPLES::
        ...
        sage: from knot_maass.hyperbolic_space.types import Circle, Parallelogram
        sage: from knot_maass.hyperbolic_space.parallelogram import parallelogram_in_circle
        sage: cr = Circle(center=vector((0,0)), radius=1)
...
def split_parallelogram(p: Parallelogram | Rectangle, n1: Integer_t = 2, n2: Integer_t = 2):
    ...
    EXAMPLE:
        sage: from knot_maass.hyperbolic_space.types import Parallelogram
        sage: from knot_maass.hyperbolic_space.parallelogram import split_parallelogram
        sage: p = Parallelogram(base=vector((0,0)), v1=vector((1,0)), v2=vector((0,1)))
...
def parallelogram_covered_by_matrices(p: Parallelogram, matrices: list[Matrix],
    ...
    from knot_maass.hyperbolic_space.geometry_utils import matrix_to_circle
...
def parallelogram_covered_by_circles(p: Parallelogram, circles: list[Circle],
    ...
    EXAMPLES:
        sage: from knot_maass.hyperbolic_space.types import Circle, Parallelogram
        sage: from knot_maass.hyperbolic_space.parallelogram import parallelogram_covered_by_circles
        sage: cr = Circle(center=vector((0,0)), radius=1)
        sage: p = Parallelogram(base=vector((0,0)), v1=vector((1,0)), v2=vector((0,1)))
    ...
    from knot_maass.hyperbolic_space.geometry_utils import point_covered_by_circles

...
from knot_maass.hyperbolic_space.types import Circle
...
def find_inverse_word(word: str) -> str:
    ...
    EXAMPLES::
        ...
        sage: from knot_maass.hyperbolic_space.word_utils import find_inverse_word
...
def is_equivalent_mod_parabolic(w1, w2, gens):
    ...
    EXAMPLES::
        ...
        sage: from knot_maass.hyperbolic_space.word_utils import is_equivalent_mod_parabolic
...
def reduce_word(word, n: int = 0):
    ...
    EXAMPLES::
        ...
        sage: from knot_maass.hyperbolic_space.word_utils import reduce_word
...
def expand_parentheses(word):
    ...
    EXAMPLES::
        ...
        sage: from knot_maass.hyperbolic_space.word_utils import expand_parentheses
...
def expand_word(word: str) -> str:
    ...
    EXAMPLES::
        ...
        sage: from knot_maass.hyperbolic_space.word_utils import expand_word
...
def word_to_element(word: str, gens: dict) -> Matrix:
    ...
    EXAMPLES::
        ...
        sage: from knot_maass.hyperbolic_space.word_utils import word_to_element
...
def translation_tuple_to_word(t: tuple, gens: dict) -> str:
    ...
    sage: from knot_maass.hyperbolic_space.word_utils import translation_tuple_to_word
...
def change_letters_in_word(word: str, new_names: dict) -> str:
    ...
    EXAMPLES::
        ...
        sage: from knot_maass.hyperbolic_space.word_utils import change_letters_in_word

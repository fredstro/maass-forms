...
from knot_maass.functions.besselk_dp import besselk_dp
from knot_maass.hyperbolic_space.upper_half_space import UpperHalfSpaceElement
from knot_maass.modform.utils import (Integer_t, Real_t, Complex_t, bessel_function, get_prec)
from knot_maass.hyperbolic_space.utils import get_lattice_values
...
def setup_matrix(space, spectral_parameter: Complex_t | Real_t,
    ...
    EXAMPLES:
        sage: from knot_maass.modform.compute_coefficients import setup_matrix
        sage: from knot_maass.all import KleinianMaassFormSpace
        sage: from knot_maass.modform.compute_coefficients import get_pb_pts

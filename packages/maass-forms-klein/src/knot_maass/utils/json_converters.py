...
from knot_maass.modform.utils import Integer_t, Real_t, get_prec, Complex_t
...
def decode_function(obj: dict | str) -> Any:
    ...
    EXAMPLES::
        ...
        sage: from knot_maass.utils.json_converters import decode_function
...
def matrix_to_json(m):
    ...
    EXAMPLES::
        sage: from knot_maass.utils.json_converters import matrix_to_json
...
def ring_element_to_json(data: Any) ->dict:
    ...
    EXAMPLES::
        ...
        sage: from knot_maass.utils.json_converters import ring_element_to_json
...
def ring_element_from_json(data: dict) -> Any:
    ...
    EXAMPLES::
        ...
        sage: from knot_maass.utils.json_converters import ring_element_from_json
...
def matrix_from_json(data):
    ...
    EXAMPLES:
        sage: from knot_maass.utils.json_converters import matrix_from_json
...
def ring_to_json(F):
    ...
    EXAMPLES:
        sage: from knot_maass.utils.json_converters import ring_to_json
...
def ring_from_json(data: dict | str) -> (RealField_class | ComplexField_class | RationalField |
    ...
    EXAMPLES:
        sage: from knot_maass.utils.json_converters import ring_from_json, number_field_to_json
...
def number_field_to_json(nf: NumberField_generic) -> dict:
    ...
    EXAMPLES:
        ...
        sage: from knot_maass.utils.json_converters import number_field_to_json
        sage: F = NumberField(x^8 + 2*x^6 + 3*x^4 + 3*x^2 + 2, 'z')
...
def number_field_from_json(data: dict | str) -> NumberField_generic:
    ...
    EXAMPLES:
        sage: from knot_maass.utils.json_converters import number_field_from_json
...
def dict_from_json(data: str | dict) -> dict:
    ...
    EXAMPLES::
        ...
        sage: from knot_maass.utils.json_converters import dict_from_json
...
def dict_to_json(data: dict) -> str:
    ...
    EXAMPLES::
        ...
        sage: from knot_maass.utils.json_converters import dict_to_json
